 ...
 * Integrates with @complyos/shared for permission checking
 */
...
import { GlobalRole, WorkspaceRole, Resource, Action } from '@complyos/shared';
...
export const RequirePermission = (options: PermissionOptions) => SetMetadata(PERMISSION_KEY, options);
